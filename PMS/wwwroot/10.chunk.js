...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_services_progress_service__ = __webpack_require__(469);
...
var StudentComponent = (function () {
    ...
    //Edit method
    StudentComponent.prototype.showEditModal = function (id) {
        this.loadStudent(id);
        this.modalAddEdit.show();
    };
    //Import method
    StudentComponent.prototype.showImportModal = function (id) {
        this.modalImport.show();
    };
    //Get Student with Id
    StudentComponent.prototype.loadStudent = function (id) {
        var _this = this;
        this._dataService
    ...
    StudentComponent.prototype.saveChange = function (form) {
        var _this = this;
        if (form.valid) {
            this.isSaved = true;
            if (this.student.id == undefined) {
                ...
                this._dataService
                    .put("/api/students/update/" + this.student.id, JSON.stringify(this.student))
                    .subscribe(function (response) {
                    _this.loadData();
                    _this.modalAddEdit.hide();
                    form.resetForm();
    ...
    StudentComponent.prototype.uploadFile = function () {
        var _this = this;
        var nativeElement = this.fileInput.nativeElement;
        this._progressService.uploadProgress.subscribe(function (progress) {
    ...
    StudentComponent.prototype.onPageChange = function (page) {
        this.isLoadData = false;
    ...
    StudentComponent.prototype.deleteStudent = function (id) {
        var _this = this;
        this._notificationService.printConfirmationDialog("Delete confirm", function () {
            return _this.deleteConfirm(id);
        });
    };
    StudentComponent.prototype.deleteConfirm = function (id) {
        var _this = this;
        this.isLoadData = false;
        this._dataService
    ...
    StudentComponent.prototype.handler = function (type, $event) {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__angular_core__["ViewChild"])("modalImport"),
...
], StudentComponent.prototype, "modalImport", void 0);
__decorate([
...
], StudentComponent.prototype, "fileInput", void 0);
StudentComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__angular_core__["Component"])({
        selector: "app-student",
        template: __webpack_require__(1602)
    }),
    __metadata("design:paramtypes", [typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__core_services_data_service__["a" /* DataService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__core_services_data_service__["a" /* DataService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1__core_services_progress_service__["a" /* ProgressService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__core_services_progress_service__["a" /* ProgressService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_2__core_services_notification_service__["a" /* NotificationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__core_services_notification_service__["a" /* NotificationService */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_4__angular_core__["NgZone"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_core__["NgZone"]) === "function" && _g || Object])
], StudentComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__student_component__ = __webpack_require__(1301);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__theme_nga_module__ = __webpack_require__(202);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__student_component__ = __webpack_require__(1301);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__student_routing__ = __webpack_require__(1393);
...
StudentModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
        ...
        declarations: [__WEBPACK_IMPORTED_MODULE_7__student_component__["a" /* StudentComponent */]],
        providers: [__WEBPACK_IMPORTED_MODULE_2__core_services_data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_9__core_services_notification_service__["a" /* NotificationService */]]
    })
], StudentModule);
