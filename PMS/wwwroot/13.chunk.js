...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_services_progress_service__ = __webpack_require__(469);
...
var LecturerComponent = (function () {
    function LecturerComponent(_authenService, _dataService, _notificationService, _progressService, _zone) {
    ...
    LecturerComponent.prototype.loadData = function () {
        var _this = this;
        this._dataService.get("/api/lecturers/getall" + "?" + this.toQueryString(this.query)).subscribe(function (response) {
            _this.queryResult = response;
            _this.isLoadData = true;
        });
    };
    //Create method
    LecturerComponent.prototype.showAddModal = function () {
        var _this = this;
        this.lecturer = {};
        this.isLoadLecturer = true;
        this._dataService.get("/api/majors/getall").subscribe(function (response) {
            _this.majors = response.items;
            _this.isLoadLecturer = true;
        });
        this.modalAddEdit.show();
    };
    //Edit method
    LecturerComponent.prototype.showEditModal = function (id) {
        this.loadLecturer(id);
        this.modalAddEdit.show();
    };
    //Import method
    LecturerComponent.prototype.showImportModal = function (id) {
        this.modalImport.show();
    };
    //Get Role with Id
    LecturerComponent.prototype.loadLecturer = function (id) {
        var _this = this;
        this._dataService.get('/api/lecturers/getlecturer/' + id)
            .subscribe(function (response) {
            _this.lecturer = response;
    ...
    LecturerComponent.prototype.saveChange = function (form) {
        var _this = this;
        if (form.valid) {
            this.isSaved = true;
    ...
    LecturerComponent.prototype.uploadFile = function () {
        var _this = this;
    ...
    LecturerComponent.prototype.toQueryString = function (obj) {
        var parts = [];
    ...
    LecturerComponent.prototype.deletelecturer = function (id) {
        var _this = this;
        this._notificationService.printConfirmationDialog("Delete confirm", function () { return _this.deleteConfirm(id); });
    };
    LecturerComponent.prototype.deleteConfirm = function (id) {
        var _this = this;
        this.isLoadData = false;
    ...
    LecturerComponent.prototype.permissionAccess = function () {
        var user = this._authenService.getLoggedInUser();
        if (user.role === "Admin") {
            this.isAdmin = true;
        }
    };
    LecturerComponent.prototype.onPageChange = function (page) {
        this.isLoadData = false;
        this.query.page = page;
        this.loadData();
    };
    LecturerComponent.prototype.handler = function (type, $event) {
...
], LecturerComponent.prototype, "modalAddEdit", void 0);
__decorate([
...
], LecturerComponent.prototype, "modalImport", void 0);
__decorate([
...
], LecturerComponent.prototype, "fileInput", void 0);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lecturer_component__ = __webpack_require__(1287);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lecturer_component__ = __webpack_require__(1287);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__lecturer_routing__ = __webpack_require__(1385);
...
LecturerModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__lecturer_routing__["a" /* routing */]
        ],
        declarations: [
