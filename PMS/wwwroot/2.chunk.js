...
var defaults = __webpack_require__(864);
var helpers = __webpack_require__(854);
...
/* MIT license */
var convert = __webpack_require__(1483);
var string = __webpack_require__(1481);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_add_observable_forkJoin__ = __webpack_require__(875);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_services_authen_service__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_router__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core_services_data_service__ = __webpack_require__(853);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ngx_bootstrap_modal__ = __webpack_require__(863);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__core_services_notification_service__ = __webpack_require__(848);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__core_common_system_constants__ = __webpack_require__(33);
...
var GroupDetailsComponent = (function () {
    function GroupDetailsComponent(_authenService, route, _notificationService, router, _dataService) {
        var _this = this;
        ...
        route.params.subscribe(function (p) {
            _this.groupId = +p['id'];
            if (isNaN(_this.groupId) || _this.groupId <= 0) {
    ...
    //Get Group with Id
    GroupDetailsComponent.prototype.loadGroupDetails = function (id) {
        var _this = this;
        this._dataService.get('/api/groups/getgroup/' + id)
            .subscribe(function (response) {
            _this.group = response;
            _this.linkGithub = response.linkGitHub.replace("https://github.com/", "");
            _this.linkDowload = response.linkGitHub + "/archive/master.zip";
            _this.loadGithub(_this.linkGithub);
            _this.loadDataCommits(_this.linkGithub + "/stats/participation");
            _this.loadCommitComment(_this.linkGithub + "/commits");
            _this.isLoadData = true;
        });
    };
    GroupDetailsComponent.prototype.loadData = function () {
        var _this = this;
        this._dataService.get("/api/groups/getall" + "?" + this.toQueryString(this.query)).subscribe(function (response) {
            _this.queryResult = response;
            _this.isLoadData = true;
        });
    };
    GroupDetailsComponent.prototype.toQueryString = function (obj) {
        var parts = [];
    ...
    //Get repository
    GroupDetailsComponent.prototype.loadGithub = function (link) {
        var _this = this;
        this._dataService.getGithub(link)
            .subscribe(function (response) {
            _this.github = response;
            _this.isLoadGit = true;
        });
    };
    GroupDetailsComponent.prototype.loadCommitComment = function (link) {
        var _this = this;
        this._dataService.getGithub(link)
            .subscribe(function (response) {
            for (var i = 0; i < 3; i++) {
                _this.commitDetails.push(response[i]);
            }
        });
    };
    GroupDetailsComponent.prototype.loadDataCommits = function (link) {
        var _this = this;
        this._dataService.getGithub(link)
            .subscribe(function (response) {
            for (var i = 40; i < response.all.length; i++) {
                _this.dataCommit.push(response.all[i]);
            }
            for (var i = 0; i < response.all.length; i++) {
                _this.commits = _this.commits + response.all[i];
            }
            _this.isLoadDataCommit = true;
        });
    };
    //Upload method
    GroupDetailsComponent.prototype.showUploadModal = function () {
        this.uploadedFile = {};
        this.modalUpload.show();
    };
    //Download method
    GroupDetailsComponent.prototype.showDownloadModal = function (id) {
        var _this = this;
        this.linkUploadedFileDowload = __WEBPACK_IMPORTED_MODULE_8__core_common_system_constants__["a" /* SystemConstants */].BASE_URL + '/api/uploadfiles/downloadfile/' + id;
    ...
    GroupDetailsComponent.prototype.saveChange = function (form) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var uploadedFileId, nativeElement;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!form.valid) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.AddUploadedFile()];
                    case 1:
                        uploadedFileId = _a.sent();
                        ...
                        this._dataService.upload('/api/uploadfiles/addfile/' + uploadedFileId, nativeElement.files[0])
                            .subscribe(function (response) {
                            _this.modalUpload.hide();
                            form.resetForm();
                            _this._notificationService.printSuccessMessage("Add File Success");
    ...
    GroupDetailsComponent.prototype.saveMark = function (form) {
        var _this = this;
        if (form.valid) {
            this.isSaved = true;
            if (this.boardEnrollment.score != null) {
                this._dataService.put('/api/boardenrollments/update/' + this.boardEnrollment.boardEnrollmentId, JSON.stringify(this.boardEnrollment))
                    ...
                    _this.isLoadMark = false;
                    _this.modalMark.hide();
                    _this.ngOnInit();
                }, function (error) { return _this._dataService.handleError(error); });
            }
        }
    ...
    //Mark method
    GroupDetailsComponent.prototype.mark = function (id) {
        var _this = this;
        this.modalMark.show();
        __WEBPACK_IMPORTED_MODULE_0_rxjs_Observable__["Observable"].forkJoin(this._dataService.get('/api/boardenrollments/getboardenrollmentsbylectureremail/' + this.thisLecturerEmail)).subscribe(function (data) {
            _this.boardEnrollmentsOfLecturer = data[0].items;
            _this.boardEnrollment = _this.boardEnrollmentsOfLecturer.find(function (be) { return be.boardID == id; });
            _this.isLoadMark = true;
        });
    };
    GroupDetailsComponent.prototype.permissionAccess = function () {
    ...
    GroupDetailsComponent.prototype.handler = function (type, $event) {
        if (type === "onHide" || type === "onHidden") {
            this.group = [];
            this.isLoadBoard = false;
        }
    };
    GroupDetailsComponent.prototype.hidemodalMark = function () {
        this.modalMark.hide();
    };
    GroupDetailsComponent.prototype.AddUploadedFile = function () {
        var _this = this;
        var uploadedFileId;
        return new Promise(function (resolve, reject) {
            _this.uploadedFile.groupId = _this.groupId;
            _this._dataService.post('/api/uploadfiles/add', JSON.stringify(_this.uploadedFile))
                .subscribe(function (response) {
            ...
            }, function (error) { return reject(_this._dataService.handleError(error)); });
        });
    };
    GroupDetailsComponent.prototype.download = function (modalUpload) {
    ...
    GroupDetailsComponent.prototype.calculateScore = function (id) {
        console.log(id);
    ...
    GroupDetailsComponent.prototype.calculateGrade = function (id) {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_core__["ViewChild"])('modalUpload'),
...
], GroupDetailsComponent.prototype, "modalUpload", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_core__["ViewChild"])('modalDownload'),
...
], GroupDetailsComponent.prototype, "modalDownload", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_core__["ViewChild"])('fileInput'),
    __metadata("design:type", typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_core__["ElementRef"]) === "function" && _c || Object)
], GroupDetailsComponent.prototype, "fileInput", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_core__["ViewChild"])('modalMark'),
...
], GroupDetailsComponent.prototype, "modalMark", void 0);
GroupDetailsComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_2__core_services_authen_service__["a" /* AuthenService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__core_services_authen_service__["a" /* AuthenService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["c" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_router__["c" /* ActivatedRoute */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_7__core_services_notification_service__["a" /* NotificationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__core_services_notification_service__["a" /* NotificationService */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */]) === "function" && _h || Object, typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_5__core_services_data_service__["a" /* DataService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__core_services_data_service__["a" /* DataService */]) === "function" && _j || Object])
...
var core_1 = __webpack_require__(0);
var chart_component_1 = __webpack_require__(1321);
...
__export(__webpack_require__(1321));
 ...
 * @namespace Chart
 */
var Chart = __webpack_require__(1455)();

Chart.helpers = __webpack_require__(854);

// @todo dispatch these helpers into appropriated helpers/helpers.* file and write unit tests!
__webpack_require__(1454)(Chart);

Chart.defaults = __webpack_require__(864);
Chart.Element = __webpack_require__(881);
Chart.elements = __webpack_require__(891);
Chart.Interaction = __webpack_require__(1322);
Chart.layouts = __webpack_require__(910);
Chart.platform = __webpack_require__(1324);
Chart.plugins = __webpack_require__(1323);
Chart.Ticks = __webpack_require__(911);
...
__webpack_require__(1450)(Chart);
...
var plugins = __webpack_require__(1468);
...
var defaults = __webpack_require__(864);
var elements = __webpack_require__(891);
var helpers = __webpack_require__(854);
...
var defaults = __webpack_require__(864);
var Element = __webpack_require__(881);
var helpers = __webpack_require__(854);
...
var defaults = __webpack_require__(864);
var helpers = __webpack_require__(854);
var Interaction = __webpack_require__(1322);
var layouts = __webpack_require__(910);
var platform = __webpack_require__(1324);
var plugins = __webpack_require__(1323);
...
var color = __webpack_require__(1328);
var defaults = __webpack_require__(864);
var helpers = __webpack_require__(854);
...
var Element = __webpack_require__(881);
var helpers = __webpack_require__(854);
var Ticks = __webpack_require__(911);
...
var helpers = __webpack_require__(996);
...
module.exports = {};
module.exports.filler = __webpack_require__(1469);
module.exports.legend = __webpack_require__(1470);
module.exports.title = __webpack_require__(1471);
...
/* MIT license */
var colorNames = __webpack_require__(1485);
...
var conversions = __webpack_require__(1482);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__group_details_component__ = __webpack_require__(1383);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_services_notification_service__ = __webpack_require__(848);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_services_data_service__ = __webpack_require__(853);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_ngx_bootstrap_modal__ = __webpack_require__(863);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_angular2_chartjs__ = __webpack_require__(1435);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GroupDetailsModule", function() { return GroupDetailsModule; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GroupDetailsRoutes = [
    //localhost:xxxx/main/user/index
    { path: '', component: __WEBPACK_IMPORTED_MODULE_0__group_details_component__["a" /* GroupDetailsComponent */] }
];
var GroupDetailsModule = (function () {
...
GroupDetailsModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_6__angular_router__["a" /* RouterModule */].forChild(GroupDetailsRoutes)
        ],
        declarations: [__WEBPACK_IMPORTED_MODULE_0__group_details_component__["a" /* GroupDetailsComponent */]],
        providers: [__WEBPACK_IMPORTED_MODULE_3__core_services_data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_2__core_services_notification_service__["a" /* NotificationService */]]
    })
], GroupDetailsModule);
...
module.exports.easing = __webpack_require__(1464);
module.exports.canvas = __webpack_require__(1463);
module.exports.options = __webpack_require__(1465);
...
module.exports = {};
module.exports.Arc = __webpack_require__(1459);
module.exports.Line = __webpack_require__(1460);
module.exports.Point = __webpack_require__(1461);
module.exports.Rectangle = __webpack_require__(1462);
