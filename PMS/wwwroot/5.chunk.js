...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GroupConfirmComponent; });
...
var GroupConfirmComponent = (function () {
    function GroupConfirmComponent(_authenService, _dataService, _notificationService) {
        ...
        this.board = {};
        this.scorePercents = [10, 20, 25, 30, 50, 75, 100];
        this.PAGE_SIZE = 5;
        this.query = {
            pageSize: this.PAGE_SIZE,
            isConfirm: "Accepted"
        };
        this.typeStatus = ["Accepted", "Pending", "Denied"];
    ...
    GroupConfirmComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loadData();
        this.permissionAccess();
        __WEBPACK_IMPORTED_MODULE_0_rxjs_Observable__["Observable"].forkJoin([
            this._dataService.get("/api/lecturers/getall/")
        ]).subscribe(function (data) {
            _this.lecturers = data[0].items;
        });
    };
    GroupConfirmComponent.prototype.loadData = function () {
        var _this = this;
    ...
    GroupConfirmComponent.prototype.toQueryString = function (obj) {
        var parts = [];
    ...
    //Create method
    GroupConfirmComponent.prototype.assignBoard = function (id) {
        var _this = this;
        ...
        this.supervisor = {};
        this.reviewer = {};
        __WEBPACK_IMPORTED_MODULE_0_rxjs_Observable__["Observable"].forkJoin(this._dataService.get('/api/groups/getgroup/' + id)).subscribe(function (data) {
            _this.group = data[0];
            if (_this.group.board == null) {
                _this.group.board = {};
                //this.lecturers = this.lecturers.filter(l => l.majorId == this.group.majorId);
                _this.board.groupId = _this.group.groupId;
                _this.board.lecturerInformations = _this.boardEnrollments;
                _this.board.lecturerInformations.chair = _this.chair;
                _this.board.lecturerInformations.secretary = _this.secretary;
                _this.board.lecturerInformations.supervisor = _this.supervisor;
                _this.board.lecturerInformations.reviewer = _this.reviewer;
                _this.isLoadBoard = true;
            }
            else {
                _this.board.groupId = _this.group.groupId;
                _this.chair = {
                    name: _this.lecturers.find(function (l) { return l.lecturerId == _this.group.board.lecturerInformations.chair.lecturerId; }).name,
                    lecturerId: _this.group.board.lecturerInformations.chair.lecturerId,
                    scorePercent: _this.group.board.lecturerInformations.chair.scorePercent
                };
                _this.secretary = {
                    name: _this.lecturers.find(function (l) { return l.lecturerId == _this.group.board.lecturerInformations.secretary.lecturerId; }).name,
                    lecturerId: _this.group.board.lecturerInformations.secretary.lecturerId,
                    scorePercent: _this.group.board.lecturerInformations.secretary.scorePercent
                };
                _this.supervisor = {
                    name: _this.lecturers.find(function (l) { return l.lecturerId == _this.group.board.lecturerInformations.supervisor.lecturerId; }).name,
                    lecturerId: _this.group.board.lecturerInformations.supervisor.lecturerId,
                    scorePercent: _this.group.board.lecturerInformations.supervisor.scorePercent
                };
                _this.reviewer = {
                    name: _this.lecturers.find(function (l) { return l.lecturerId == _this.group.board.lecturerInformations.reviewer.lecturerId; }).name,
                    lecturerId: _this.group.board.lecturerInformations.reviewer.lecturerId,
                    scorePercent: _this.group.board.lecturerInformations.reviewer.scorePercent
                };
                _this.boardEnrollments = {
                    chair: _this.chair,
                    secretary: _this.secretary,
    ...
    //Mark method
    GroupConfirmComponent.prototype.mark = function (id) {
        var _this = this;
        this.modalMark.show();
        __WEBPACK_IMPORTED_MODULE_0_rxjs_Observable__["Observable"].forkJoin(this._dataService.get('/api/boardenrollments/getboardenrollmentsbylectureremail/' + this.thisLecturerEmail)).subscribe(function (data) {
            ...
            console.log(_this.boardEnrollmentsOfLecturer);
            _this.boardEnrollment = _this.boardEnrollmentsOfLecturer.find(function (be) { return be.boardID == id; });
            _this.isLoadMark = true;
        });
    };
    GroupConfirmComponent.prototype.handler = function (type, $event) {
        if (type === "onHide" || type === "onHidden") {
            this.group = [];
            this.isLoadBoard = false;
        }
    };
    GroupConfirmComponent.prototype.hidemodalAddEdit = function () {
        this.modalAddEdit.hide();
    };
    GroupConfirmComponent.prototype.hidemodalMark = function () {
        this.modalMark.hide();
    };
    GroupConfirmComponent.prototype.saveChange = function (form) {
        var _this = this;
        if (form.valid) {
            this.isSaved = true;
    ...
    GroupConfirmComponent.prototype.saveMark = function (form) {
        var _this = this;
        if (form.valid) {
            this.isSaved = true;
    ...
    GroupConfirmComponent.prototype.permissionAccess = function () {
    ...
    GroupConfirmComponent.prototype.onPageChange = function (page) {
        this.query.page = page;
        this.loadData();
    };
    return GroupConfirmComponent;
}());
__decorate([
...
], GroupConfirmComponent.prototype, "modalAddEdit", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__angular_core__["ViewChild"])('modalMark'),
...
], GroupConfirmComponent.prototype, "modalMark", void 0);
GroupConfirmComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__angular_core__["Component"])({
        selector: 'app-group',
        styles: [__webpack_require__(1487)],
        template: __webpack_require__(1572)
    }),
    __metadata("design:paramtypes", [typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_6__core_services_authen_service__["a" /* AuthenService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__core_services_authen_service__["a" /* AuthenService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__core_services_data_service__["a" /* DataService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__core_services_data_service__["a" /* DataService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_2__core_services_notification_service__["a" /* NotificationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__core_services_notification_service__["a" /* NotificationService */]) === "function" && _e || Object])
], GroupConfirmComponent);

var _a, _b, _c, _d, _e;
//# sourceMappingURL=confirm-group.component.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__confirm_group_component__ = __webpack_require__(1278);
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_0__confirm_group_component__["a" /* GroupConfirmComponent */]
    }
];
var routing = __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* RouterModule */].forChild(routes);
//# sourceMappingURL=confirm-group.routing.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__confirm_group_component__ = __webpack_require__(1278);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_services_notification_service__ = __webpack_require__(848);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_services_data_service__ = __webpack_require__(853);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_core__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__confirm_group_routing__ = __webpack_require__(1352);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__theme_nga_module__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_angular_2_dropdown_multiselect__ = __webpack_require__(909);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GroupConfirmModule", function() { return GroupConfirmModule; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GroupConfirmModule = (function () {
    function GroupConfirmModule() {
    }
    return GroupConfirmModule;
}());
GroupConfirmModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__confirm_group_routing__["a" /* routing */]
        ],
        declarations: [
            __WEBPACK_IMPORTED_MODULE_1__confirm_group_component__["a" /* GroupConfirmComponent */]
        ],
...
//# sourceMappingURL=confirm-group.module.js.map
