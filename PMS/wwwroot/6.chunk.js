...
var GroupComponent = (function () {
    function GroupComponent(_authenService, _dataService, _notificationService) {
    ...
    GroupComponent.prototype.loadDataDependOnLecturer = function () {
        var _this = this;
        this._dataService.get("/api/groups/getall?pageSize=3&isConfirm=Pending&email=" + this.user.email).subscribe(function (response) {
            _this.queryResult = response;
            _this.isLoadData = true;
        });
    };
    GroupComponent.prototype.loadDataDependOnStudent = function () {
        var _this = this;
        this._dataService.get("/api/students/getgroups/" + this.user.email + "?page=3").subscribe(function (response) {
            _this.queryResult = response;
            console.log(response);
            _this.isLoadData = true;
        });
    };
    GroupComponent.prototype.toQueryString = function (obj) {
        var parts = [];
    ...
    //Create method
    GroupComponent.prototype.showAddModal = function () {
        var _this = this;
        this.isExist = true;
        this.group = {};
        this.loadStudents();
        this._dataService.get('/api/lecturers/getlecturerbyemail/' + this.user.email)
            ...
            _this.group.lecturerId = response.lecturerId;
            _this.group.lecturerEmail = _this.user.email;
            _this.group.majorId = response.majorId;
            _this.projects = response.projectDetails;
            _this.isLoadGroup = true;
        });
        this.modalAddEdit.show();
    };
    GroupComponent.prototype.handler = function (type, $event) {
    ...
    //Edit method
    GroupComponent.prototype.showEditModal = function (id) {
        var _this = this;
        this.loadGroup(id);
        this.loadStudents();
        this._dataService.get('/api/lecturers/getlecturerbyemail/' + this.user.email)
    ...
    GroupComponent.prototype.hideAddEditModal = function () {
        this.modalAddEdit.hide();
    };
    //Get Group with Id
    GroupComponent.prototype.loadGroup = function (id) {
        var _this = this;
        this._dataService.get('/api/groups/getgroup/' + id)
            .subscribe(function (response) {
            _this.group = response;
            for (var _i = 0, _a = _this.group.studentInformations; _i < _a.length; _i++) {
                var student = _a[_i];
    ...
    GroupComponent.prototype.saveChange = function (form) {
        var _this = this;
        if (form.valid) {
            this.isSaved = true;
            if (this.group.groupId == undefined) {
                ...
                this.group.studentEmails = [];
                for (var _b = 0, _c = this.students; _b < _c.length; _b++) {
                    var s = _c[_b];
                    this.group.studentEmails.push(s.split(' - ')[1]);
                }
                this.groupJson = {
    ...
    GroupComponent.prototype.permissionAccess = function () {
    ...
    GroupComponent.prototype.onPageChange = function (page) {
        this.query.page = page;
        this.permissionAccess();
    };
    GroupComponent.prototype.loadStudents = function () {
        var _this = this;
        this._dataService.get("/api/students/getall").subscribe(function (response) {
            _this.allStudents = [];
            for (var _i = 0, _a = response.items; _i < _a.length; _i++) {
                var student = _a[_i];
                _this.allStudents.push({ id: student.name + " - " + student.email, name: student.email });
            }
            _this.isLoadStudent = true;
        });
    };
    GroupComponent.prototype.acceptGroup = function (id) {
        var _this = this;
        this._dataService.get('/api/groups/getgroup/' + id)
            .subscribe(function (response) {
            _this.group = response;
            _this.groupJson = {
                ...
                isConfirm: "Accepted",
                projectId: _this.group.projectId,
                linkGitHub: _this.group.linkGitHub,
                lecturerEmail: _this.user.email,
                lecturerId: _this.group.lecturerId,
                majorId: _this.group.majorId,
                quarterId: _this.group.quarterId,
                studentEmails: _this.group.studentEmails
            };
            _this._dataService.put('/api/groups/update/' + _this.group.groupId, JSON.stringify(_this.groupJson))
                .subscribe(function (response) {
                _this.permissionAccess();
                _this._notificationService.printSuccessMessage("Group Accepted");
                _this.isLoadData = false;
            });
        });
    };
    GroupComponent.prototype.rejectGroup = function (id) {
        var _this = this;
        this._dataService.get('/api/groups/getgroup/' + id)
            .subscribe(function (response) {
            _this.group = response;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__group_component__ = __webpack_require__(1286);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__group_component__ = __webpack_require__(1286);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_services_notification_service__ = __webpack_require__(848);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_services_data_service__ = __webpack_require__(853);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_core__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__group_routing__ = __webpack_require__(1384);
...
GroupModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__group_routing__["a" /* routing */]
        ],
        declarations: [
            __WEBPACK_IMPORTED_MODULE_1__group_component__["a" /* GroupComponent */]
        ],
