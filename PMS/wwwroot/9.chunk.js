...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ngx_bootstrap_modal__ = __webpack_require__(863);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__core_services_notification_service__ = __webpack_require__(848);
...
var TagComponent = (function () {
    function TagComponent(_dataService, _notificationService) {
        ...
        this.isSaved = false;
        this.query = {
            pageSize: __WEBPACK_IMPORTED_MODULE_2__core_common_system_constants__["a" /* SystemConstants */].PAGE_SIZE
        };
    }
    TagComponent.prototype.ngOnInit = function () {
        this.loadData();
    };
    TagComponent.prototype.loadData = function () {
        var _this = this;
        this._dataService
    ...
    TagComponent.prototype.toQueryString = function (obj) {
        var parts = [];
    ...
    //Create method
    TagComponent.prototype.showAddModal = function () {
        this.tag = {};
        this.isLoadTag = true;
        this.modalAddEdit.show();
    };
    //Edit method
    TagComponent.prototype.showEditModal = function (id) {
        this.loadTag(id);
        this.modalAddEdit.show();
    };
    //Get Tag with Id
    TagComponent.prototype.loadTag = function (id) {
        var _this = this;
        this._dataService
    ...
    TagComponent.prototype.saveChange = function (form) {
        var _this = this;
        if (form.valid) {
            this.isSaved = true;
    ...
    TagComponent.prototype.deleteConfirm = function (id) {
        var _this = this;
        this.isLoadData = false;
        this._dataService
    ...
    TagComponent.prototype.handler = function (type, $event) {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])("modalAddEdit"),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tag_component__ = __webpack_require__(1311);
...
var routes = [
    {
        path: "",
        component: __WEBPACK_IMPORTED_MODULE_1__tag_component__["a" /* TagComponent */]
    }
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__tag_component__ = __webpack_require__(1311);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__tag_routing__ = __webpack_require__(1416);
...
TagModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__tag_routing__["a" /* routing */]
        ],
        declarations: [__WEBPACK_IMPORTED_MODULE_7__tag_component__["a" /* TagComponent */]],
